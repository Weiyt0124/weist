...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
        en: {
            ...
            clear: '清空',
            drag: '选中图片点击上传即可',
            sizeError: '$1 不能大于 $2',// $1=file name ,$2=max ie( example.jpg has has exceed the size limit of 2mb)
            extError: '$1 格式不支持上传',//$1=file extension ie(exe files are not supported)
